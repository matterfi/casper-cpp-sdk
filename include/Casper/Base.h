...
*/
template <typename T> inline T hexToInteger(const std::string& hex)
{
...
template <typename T> inline std::string integerToHex(T val)
{
...
namespace nlohmann
{
template <> struct adl_serializer<uint128_t>
{
...
template <> struct adl_serializer<uint256_t>
{
...
template <> struct adl_serializer<uint512_t>
{
